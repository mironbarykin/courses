...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Getting cell's neighbours and if they are unknown, add to cells set
        cells = set()
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
        ...
        while flag:
            ...
            # Getting and Marking all safes and mines from AI's knowledge
            for sentence in self.knowledge:
    ...
    def make_safe_move(self):
        ...
        # If any moves are available returns move, otherwise None
        if moves:
    ...
    def make_random_move(self):
        ...
        # Runs through the board and adding moves which is unknown for AI
        for i in range(self.height):
            for j in range(self.width):
